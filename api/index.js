(function () {
  ...
  function computeChecksum(score, nonce, token, fingerprint) {
    var input = score + "|" + nonce + "|" + token + "|" + fingerprint;
  ...
  submitConfirm.addEventListener("click", function () {
    ...
    fetch("api/score_nonce.php", {
      ...
      .then(function (nonceData) {
        ...
        return computeChecksum(String(game.score), nonceData.data.nonce, nonceData.data.token, getUserFingerprint()).then(function (checksum) {
